...
int main(int argc, char *argv[])
{
	...
	//fprintf(stderr, "~~~execution 1 start~~~\n");
    Logger::LogEvent("Begin execution 1");
    Execution1(argv[1]);
	//fprintf(stderr, "~~~execution 1 end~~~\n");
    Logger::LogEvent("Done with execution 1");
	


	//fprintf(stderr, "~~~execution 2 start~~~\n");
    Logger::LogEvent("Begin execution 2");
    Execution2(argv[1]);
	//fprintf(stderr, "~~~execution 2 end~~~\n");
    Logger::LogEvent("Done with execution 2");


	//fprintf(stderr, "~~~execution 3 start~~~\n");
    Logger::LogEvent("Begin execution 3");
    Execution3(argv[1]);
	//fprintf(stderr, "~~~execution 3 end~~~\n");
    Logger::LogEvent("Done with execution 3");

	//fprintf(stderr, "~~~execution 4 start~~~\n");
    Logger::LogEvent("Begin execution 4");
    Execution4(argv[1]);
	//fprintf(stderr, "~~~execution 4 end~~~\n");
